...
class LoadoutDataStore(private val playerName: String?) : PagingSource<Int, LoadoutModel>(), BaseDataStore {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, LoadoutModel> {
        try {
            ...
            val response = RetrofitBuilder.playerService.getLoadouts(request)
