...
class MatchHistoryDataStore(private val playerName: String?) : PagingSource<Int, MatchHistoryModel>(), BaseDataStore {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MatchHistoryModel> {
        try {
            ...
            val response = RetrofitBuilder.playerService.getMatchHistory(request)
